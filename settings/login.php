...
<aside id="menu">
    ...
    <main id="glowny">
        ...
        <?php
            ...
            echo "<input type='text' value='{$row['Login']}' name='login'>";
            if(isset($_SESSION['login_change_error']))
            {
                if($_SESSION['login_change_error']==1)
                    echo "<p>LOGIN MUSI MIEĆ 8 ZNAKÓW</p>";
                if($_SESSION['login_change_error']==2)
                    echo "<p>LOGIN JEST ZAJĘTY</p>";
                unset($_SESSION['login_change_error']);
            }
            ?>
            <input type="submit">
        </form>
