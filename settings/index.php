...
<aside id="menu">
    ...
    <main id="glowny">
        ...
        echo "<section class='dane'>Email: {$row['Email']}</section>";
        echo "<section class='dane'>Login: {$row['Login']}</section>";
        ?>
        <section class="change" onclick="email()">Zmień email</section>
        <section class="change" onclick="login()">Zmień login</section>
        <section class="change" onclick="pass()">Zmień hasło</section>
        <section class="change" onclick="faq()">FAQ</section>
