...
<aside id="menu">
    ...
    <main id="glowny">
        <dl>
            <dt>Czy gra wymaga połączenia z Internetem?</dt>
            <dd>Tak, do gry online wymagane jest stabilne połączenie z Internetem.</dd>    
            <dt>Czy gra obsługuje język polski?</dt>
            <dd>Tak, gra jest dostępna tylko w języku polskim.</dd>
            <dt>Jak zdobywać dodatkowe przedmioty w grze?</dt>
            <dd>Dodatkowe przedmioty można zdobyć poprzez: Rozwijanie umiejętności oraz pokonywanie potworów.</dd>
            <dt>Jak zgłosić błąd w grze?</dt>
            <dd>Możesz zgłosić błąd, poprzez email na ten adres pawelstanislawczyk841@gmail.com</dd>
            <dt>Czy moje postępy w grze są synchronizowane między urządzeniami?</dt>
            <dd>Tak, jeśli korzystasz z konta w naszej platformie, twoje postępy są automatycznie zapisywane w chmurze.</dd>
            <dt>Czy mogę zmienić poziom trudności podczas gry?</dt>
            <dd>Nie da się zmienić poziomu trudności gry, gra została zbalansowana dla tej kąkretnej trudności</dd>
            <dt>Czy szukamy chętnych do pracy nad grą?</dt>
            <dd>Nie obecnie nie potrzebujemy ludzi do pracy.</dd>
        <dl>
    </main>
</body>
<script>
