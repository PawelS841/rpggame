...
<body>
    <?php
        ...
        $sql="SELECT mine.name as name,image,mine.id as id,speed,lvl FROM mine JOIN items ON items.ID=mine.Item_ID WHERE mine.id={$id}";
        $resoult=mysqli_query($connect,$sql);
        $row=mysqli_fetch_assoc($resoult);
...
<aside id="menu">
    ...
    <main id="sorceget">    
        <section class="return" onclick="return_mine()">Powrót</section>
        <img src="../icons/rock.svg" alt="rock.svg" class="source_img">
        <section class="speed">
